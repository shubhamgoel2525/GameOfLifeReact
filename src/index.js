...
import './index.css';
import { ButtonToolbar, DropdownItem, DropdownButton, ButtonGroup, Button } from 'react-bootstrap';
	...
	render() {
		return (
				<div className="center">
					<ButtonToolbar>
						<ButtonGroup><Button className="btn btn-default" onClick={this.props.playButton}>
							Play
						</Button>
